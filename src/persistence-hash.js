/** @module persistence-hash */

/**
 * Generates a UUID version 4 string from {@link http://stackoverflow.com/a/105074}
 * @function
 * @returns {string} UUID
 */
var uuid = (function() {
 ...
 * @param {object} modelClass A model class object belonging to namespaces generated by {@link moat.init}()
 * @returns {function} A function returning an object having mapper operations for the given model class
 */
